...
| **Seregin** — conditional Type-II exclusion (arXiv:2304.04045 scenario; **2507.08733** *"under some assumptions, such blowups cannot happen"*) | **C2** (statement); **scenario map + ancient-Euler Liouville port table at C1/named** (grok GO-018/021, byte-identical, `docs/gomap_verification_round3_2026-06-14.md`; the specific 2507.08733 theorem-numbers are Grok-read — **a 2507.08733 line-read is required before leaning on them**) | Euler scaling + **ancient-Euler Liouville** = the NS-048 Hole-B machinery (general-3D ancient-Euler Liouville = the live gap), confirmed verbatim | NS-050, NS-048 |
