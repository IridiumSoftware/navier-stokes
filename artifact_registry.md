...
| NS-010 | DIAGNOSTIC | external-theorem + computed | :tested | PDE-method (validated in 1D + 2D models) | FT(1989); SSF(1983); `burgers_analyticity_strip.jl` (T-01) + `spectral_clm_blowup.jl` (1b: T-03/T-04) + `spectral_2d_control.jl` (1c-2D: T-05 regularity control); companions ns010_*_companion.md |
